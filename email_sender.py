...
class EmailSender:
    ...
    def send_consultation_confirmation(self, to_email: str, name: Optional[str] = None) -> bool:
        ...
        subject = "Консультация с Андреем Поповым - подтверждение"
...
<body>
    <div class="container">
        <div class="header">
            <h1>Консультация с Андреем Поповым</h1>
        </div>

        <div class="content">
            <h2>{name_greeting}</h2>

            <p>Спасибо за интерес к моим AI-решениям для автоматизации юридической работы!</p>

            <p>Я свяжусь с вами в ближайшее время для согласования удобного времени консультации (30 минут).</p>
            ...
            <div class="contact-info">
                <h3>Мои контакты:</h3>
                <p>
                    <strong>Андрей Попов</strong><br>
                    Юрист с 24-летним стажем<br>
                    Разработчик AI-систем для юридической автоматизации
                </p>
                <p>
        ...
        <div class="footer">
            <p>Это письмо отправлено в ответ на ваш запрос консультации через Telegram бот @LegalAI_Popov_Andrew</p>
        </div>
    </div>
</body>
</html>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Я помогу создать AI-систему, которая будет анализировать ваши договоры и выявлять все эти ошибки автоматически.</p>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Отлично! Я проведу демо-анализ вашего договора, чтобы вы увидели как работает AI-система на реальном документе.</p>

            <div class="steps">
                <h3>Следующие шаги:</h3>

                <div class="step">
                    <strong>Шаг 1:</strong> Отправьте мне ваш договор<br>
                    <small>Можно в любом формате: Word, PDF, скан. Конфиденциальность гарантирую.</small>
                </div>

                <div class="step">
                    <strong>Шаг 2:</strong> Я проведу анализ (1-2 часа)<br>
